...
public class EntityCatty extends EntityTameable
{
    /**
    ...
    public EntityCatty(World p_i1688_1_)
    {
        ...
        //this.tasks.addTask(6, new EntityAIOcelotSit((EntityOcelot)this, 1.33D));
    ...
    public EntityCatty createChild(EntityAgeable p_90011_1_)
    {
    	EntityCatty entityocelot = new EntityCatty(this.worldObj);
    ...
    public boolean canMateWith(EntityAnimal p_70878_1_)
    {
        ...
        else if (!(p_70878_1_ instanceof EntityCatty))
        {
            return false;
        }
        else
        {
        	EntityCatty entityocelot = (EntityCatty)p_70878_1_;
